...
public class SelectedFileVBox extends VBox {
    ...
    public SelectedFileVBox() {
        ...
        String formattedFieldName=formatFieldName("%-20s", Constants.SF_TEXT_FILENAME); //format the  Text node
//        setFileDetailsTextProperties(fileName); // set the font
        ...
        formattedFieldName=formatFieldName("%-15s", Constants.SF_TEXT_PACKAGENAME); //format the  Text node
//        setFileDetailsTextProperties(packageName);
        ...
        formattedFieldName=formatFieldName("%-22s", Constants.SF_TEXT_AUTHORS); //format the  Text node
